            ...
            class AttributeCategories
            {
                  ...
                  class State
                  {
                        class Attributes
                        {
                              ...
                              class CFP_OverrideLoadout
                              {
                                    //--- Mandatory properties
                                    displayName = "Override CFP Scripted Loadout"; // Name assigned to UI control class Title
                                    tooltip = "CFP units have scripted loadouts for items in uniforms, vests and backpacks. Enable this to override these loadouts."; // Tooltip assigned to UI control class Title
                                    property = "CFP_OverrideLoadout"; // Unique config property name saved in SQM
