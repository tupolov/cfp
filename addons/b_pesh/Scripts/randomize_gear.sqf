...
if (isServer) then
{
	    ...
	    ) then
	{
		...
		_this setObjectTextureGlobal [0, [
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_1.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_2.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_3.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_1.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_2.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_woodland_3.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_3_color_desert_1.paa",
			"\x\cfp\addons\b_pesh\data\Peshmerga_3_color_desert_2.paa"
		] select _randomSeed1];
	};
