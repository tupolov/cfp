...
class CfgVehicles
{
	...
	class SP_0000_Standard_WorkUniform_Hunter: B_Soldier_base_F
	{
		...
		model = "\x\cfp\addons\common_character\Models\WorkUniform.p3d";
		Items[] = {};
		weapons[] = {"Throw","Put"};
		magazines[] = {};
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\Hunter.paa"};  
	...
	class SP_0000_Standard_WorkUniform_ATacsFG: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\ATacsFG.paa"};  
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class SP_0000_Standard_WorkUniform_NodUrban: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\NodUrban.paa"};  
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
...
class cfgWeapons
{
	...
	class SP_0000_Standard_WorkUniform_Hunter: Uniform_Base
	{
		...
		picture = "\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\ui\Hunter.jpg";
		author = "SP Craig";
	...
	class SP_0000_Standard_WorkUniform_Hunter2: Uniform_Base
	{
		...
		picture = "\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\ui\Hunter2.jpg";
		author = "SP Craig";
	...
	class SP_0000_Standard_WorkUniform_ATacsFG: Uniform_Base
	{
		...
		picture = "\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\ui\ATacsFG.jpg";
		author = "SP Craig";
	...
	class SP_0000_Standard_WorkUniform_NodUrban: Uniform_Base
	{
		...
		picture = "\x\cfp\addons\common_character\Uniforms\WorkUniform\0000_Standard\ui\NodUrban.jpg";
		author = "SP Craig";
