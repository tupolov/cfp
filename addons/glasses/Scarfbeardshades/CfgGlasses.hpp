...
*/
	class CFP_Scarfbeardshades_green: None
	{
		scope = 2;
	...
	class CFP_Scarfbeardshades_grey: None
	{
		scope = 2;
	...
	class CFP_Scarfbeardshades_white: None
	{
		scope = 2;
	...
	class CFP_Scarfbeard_green: None
	{
		scope = 2;
	...
	class CFP_Scarfbeard_grey: None
	{
		scope = 2;
	...
	class CFP_Scarfbeard_white: None
	{
		scope = 2;
	...
	class CFP_Scarfshades_grey: None
	{
		scope = 2;
	...
	class CFP_Scarfshades_white: None
	{
		...
		hiddenSelectionsTextures[] = {"x\cfp\addons\glasses\75facewear\tex\glass_dark_ca.paa","\x\cfp\addons\glasses\ShemaghNeck\shemagh_neck_white.paa"};
		picture = "\x\cfp\addons\glasses\Goggles\ui\Black.jpg";
		identityTypes[] = {"NoGlasses",0};
	};
