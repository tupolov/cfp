...
if (local _this) then 
{
	...
	if ((_class == "cfp_i_is_offroad_flag") or
	...
	if ((_class == "cfp_i_is_pickup_PK_flag") or
	...
	if ((_class == "cfp_i_is_BTR40_MG_flag") or
	...
	if ((_class == "cfp_i_is_M113_flag") or
	...
	if ((_class == "cfp_i_is_BMP1_flag") or
	...
	if ((_class == "cfp_i_is_BMP2_PKM_flag") or
	...
	if ((_class == "cfp_i_is_T34_flag") or
	...
	if ((_class == "cfp_i_is_T55_flag") or
	...
	if ((_class == "cfp_i_is_T72_flag") or
