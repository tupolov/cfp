...

{
		...
		( typeof _x == "rhsgref_ins_rifleman_aksu" )) then
	{
		...
		sleep 1;
		deleteVehicle _x;
		_crewMember = "isc_alNusra_crewman_i" createVehicle position _this;
...
// remove extra russian on the GAZZ66 ZU23
_vehType = typeOf _this;

if ((_vehType == "isc_alNusra_gaz66_zu23_i")  or
	(_vehType == "isc_alNusra_Ural_zu23_i")) then
{
