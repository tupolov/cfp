class cfp_i_is_base : I_Soldier_A_F
{
	...
	faction = "CFP_I_IS"; // Puts unit under new faction
	modelSides[] = {0,1,2,3};
	side = 2;
	vehicleClass = "CFP_I_IS_INFANTRY"; // Puts unit in the vehicleclass
	icon = "iconMan"; 
	...
	linkedItems[] = {""}; // Item's added to the unit. 
	respawnLinkedItems[] = {""}; // Item's added to the unit. Should be identical to the linkedItems section.
...
class cfp_i_is_team_leader : cfp_i_is_base
{
	...
	headgearProbability = 50;
	randomWeaponProbability = 50;
	linkedItems[] = {"IS_uniform_i","V_TacVestIR_blk", "ItemMap", "ItemCompass", "ItemWatch",  "ItemRadio"}; // Item's added to the unit. 
	respawnLinkedItems[] = {"IS_uniform_i","V_TacVestIR_blk", "ItemMap", "ItemCompass", "ItemWatch", "ItemRadio"}; // Item's added to the unit. Should be identical to the linkedItems section.
...
class cfp_i_is_rifleman : cfp_i_is_base
{
	...
	linkedItems[] = {"IS_uniform_i","UO_AK_VEST_Olive", "ItemRadio"};  
	respawnLinkedItems[] = {"IS_uniform_i","UO_AK_VEST_Olive", "ItemRadio"};
