...
if (isServer) then
{
	...
	if ((_class == "cfp_o_is_team_leader") or
		...
		) then
	{
		...
		{
			[_this,"insignia_cfp_o_IS"] call BIS_fnc_setUnitInsignia;
		};
		...
		_this setObjectTextureGlobal [0, [
			...
			"\x\cfp\addons\uniforms\FieldUniform\IS\IS_tan_s_woodland2_p.paa"
	...
	if ((_class == "cfp_o_is_militaman") or
		(_class == "cfp_o_is_irregular") or
