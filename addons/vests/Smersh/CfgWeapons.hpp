...
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Smersh_Tan.paa";
		scope = 2;
...
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Smersh_ArmyGreen.paa";
		scope = 2;
...
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Smersh_Green.paa";
		scope = 2;
...
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Smersh_Creme.paa";
		scope = 2;
...
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Smersh_Olive.paa";
		scope = 2;
