	...
	class CFP_Tactical1_Woodland: V_PlateCarrier1_rgr
{
	...
	class CFP_Tactical1_DPM: V_PlateCarrier1_rgr
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Tactical1_Woodland.paa";
		scope = 2;
		displayName = "Tactical 1 (DPM)";
		// picture = "\x\cfp\addons\vests\Tactical1\ui\Black.jpg";
		model = "\x\cfp\addons\models\Tactical1";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\Tactical1\DPM.paa"};
		hiddenSelections[] = {"Camo"};
	...
	class CFP_Tactical1_White2: V_PlateCarrier1_rgr
{
    picture = "\x\cfp\addons\vests\data\ui\icon_SP_Tactical1_White.paa";
		...
		// picture = "\x\cfp\addons\vests\Tactical1\ui\Black.jpg";
		model = "\x\cfp\addons\models\Tactical1";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\Tactical1\White2.paa"};
		hiddenSelections[] = {"Camo"};
	...
	class CFP_Tactical1_Berez: V_PlateCarrier1_rgr
{
    picture = "\x\cfp\addons\vests\data\ui\icon_SP_Tactical1_White.paa";
		...
		// picture = "\x\cfp\addons\vests\Tactical1\ui\Black.jpg";
		model = "\x\cfp\addons\models\Tactical1";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\Tactical1\Berez.paa"};
		hiddenSelections[] = {"Camo"};
