	...
	class CFP_Modular1_Flecktarn: V_PlateCarrier1_rgr
{
	...
	class CFP_Modular1_IDF: V_PlateCarrier1_rgr
{
    picture = "\x\cfp\addons\vests\data\ui\icon_SP_Modular1_Green.paa";
		scope = 2;
		displayName = "Modular 1 (IDF)";
		// picture = "\x\cfp\addons\vests\Modular1\ui\Green.jpg";
		model = "A3\Characters_F_Beta\INDEP\equip_ia_vest01";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\Modular1\IDF.paa"};
		hiddenSelections[] = {"Camo"};
	...
	class CFP_Modular1_DCU: V_PlateCarrier1_rgr
{
	...
	class CFP_Modular1_Multicam: V_PlateCarrier1_rgr
{
    picture = "\x\cfp\addons\vests\data\ui\icon_SP_Modular1_Green.paa";
		scope = 2;
		displayName = "Modular 1 (Multicam)";
		// picture = "\x\cfp\addons\vests\Modular1\ui\Green.jpg";
		model = "A3\Characters_F_Beta\INDEP\equip_ia_vest01";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\Modular1\Multicam.paa"};
		hiddenSelections[] = {"Camo"};
