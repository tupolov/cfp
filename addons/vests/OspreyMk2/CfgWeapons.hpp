	...
	class CFP_Osprey1_Wd: CUP_V_B_BAF_DDPM_Osprey_Mk3_Empty
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Osprey1_Wd.paa";
		scope = 2;
		displayName = "Osprey Mk2 (M81 - Empty)";
...
class CFP_Osprey1_Green: CUP_V_B_BAF_DDPM_Osprey_Mk3_Empty
{
    picture = "\x\cfp\addons\vests\data\ui\icon_CFP_Osprey1_Wd.paa";
		scope = 2;
		displayName = "Osprey Mk2 (Green - Empty)";
		// picture = "\x\cfp\addons\vests\OspreyMk2\ui\icon_v_mk2_empty_wd.paa";
		hiddenSelectionsTextures[] = {"\x\cfp\addons\vests\OspreyMk2\mk2_empty_green.paa","\x\cfp\addons\vests\OspreyMk2\mk2_empty_green.paa","\x\cfp\addons\vests\OspreyMk2\mk2_empty_green.paa","\x\cfp\addons\vests\OspreyMk2\mk2_empty_green.paa"};
	};
