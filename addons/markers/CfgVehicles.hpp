class CfgMarkerClasses
{
	class CFP_Markers
	{
		displayName = "CFP Markers";
	};
};
class CfgMarkers
{
	class CFP_MARKER_BASE
	{
		scope = 2;
		scopeCurator = 2;
		author = "Siege-A";
		name = "CFP Markers";
		markerClass = "CFP_Markers";
	...
	class CFP_MARKER_BURKINA_FASO : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_BURUNDI : CFP_MARKER_BASE
	{
		name = "[AFRICA] Burundi";
	...
	class CFP_MARKER_CAMEROON : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_CAPE_VERDE : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_CENTRAL_AFRICA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_COTE_DIVOIRE : CFP_MARKER_BASE
	{
		name = "[AFRICA] Cote d'Ivoire";
	...
	class CFP_MARKER_DEMOCRATIC_CONGO : CFP_MARKER_BASE
	{
		name = "[AFRICA] Democratic Republic of the Congo";
	...
	class CFP_MARKER_DJIBOUTI : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_EQUATORIAL_GUINEA : CFP_MARKER_BASE
	{
		name = "[AFRICA] Equatorial Guinea";
	...
	class CFP_MARKER_ERITREA : CFP_MARKER_BASE
	{
		name = "[AFRICA] Eritrea";
	...
	class CFP_MARKER_ETHIOPIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_LIBERIA : CFP_MARKER_BASE
	{
		name = "[AFRICA] Liberia";
	...
	class CFP_MARKER_MAURITIUS : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_MOROCCO : CFP_MARKER_BASE
	{
		name = "[AFRICA] Morocco";
	...
	class CFP_MARKER_MOZAMBIQUE : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_NAMIBIA : CFP_MARKER_BASE
	{
		name = "[AFRICA] Namibia";
	...
	class CFP_MARKER_REPUBLIC_CONGO : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_SENEGAL : CFP_MARKER_BASE
	{
		name = "[AFRICA] Senegal";
	...
	class CFP_MARKER_SEYCHELLES : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_SIERRA_LEONE : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_SOMALIA : CFP_MARKER_BASE
	{
		name = "[AFRICA] Somalia";
	...
	class CFP_MARKER_SOUTH_SUDAN : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_TANZANIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_THE_GAMBIA : CFP_MARKER_BASE
	{
		name = "[AFRICA] The Gambia";
	...
	class CFP_MARKER_ZIMBABWE : CFP_MARKER_BASE
	{
		...
		class CFP_MARKER_AFGHANISTAN : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Afghanistan";
	...
	class CFP_MARKER_HEZBOLLAH : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Hezbollah";
	...
	class CFP_MARKER_KINGDOM_BAHRAIN : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_LEBANON : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Lebanon";
	...
	class CFP_MARKER_SAUDI_ARABIA : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Saudi Arabia";
	...
	class CFP_MARKER_STATE_PALESTINE : CFP_MARKER_BASE
	{
		name = "[MIDEAST] State of Palestine";
	...
	class CFP_MARKER_TURKEY : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Turkey";
	...
	class CFP_MARKER_TURKISH_NORTH_CYPRUS : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Turkish Republic of Northern Cyprus";
	...
	class CFP_MARKER_UNITED_ARAB_EMIRATES : CFP_MARKER_BASE
	{
		name = "[MIDEAST] United Arab Emirates";
	...
	class CFP_MARKER_YEMEN : CFP_MARKER_BASE
	{
		name = "[MIDEAST] Yemen";
	...
	class CFP_MARKER_ANDORRA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Andorra";
	...
	class CFP_MARKER_AUSTRIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Austria";
	...
	class CFP_MARKER_BELARUS : CFP_MARKER_BASE
	{
		name = "[EUROPE] Belarus";
	...
	class CFP_MARKER_BELGIUM : CFP_MARKER_BASE
	{
		name = "[EUROPE] Belgium";
	...
	class CFP_MARKER_BOSNIA_HERZEGOVINA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_BULGARIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_CROATIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Croatia";
	...
	class CFP_MARKER_CZECH_REPUBLIC : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_DENMARK : CFP_MARKER_BASE
	{
		name = "[EUROPE] Denmark";
	...
	class CFP_MARKER_ESTONIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Estonia";
	...
	class CFP_MARKER_FINLAND : CFP_MARKER_BASE
	{
		name = "[EUROPE] Finland";
	...
	class CFP_MARKER_ICELAND : CFP_MARKER_BASE
	{
		name = "[EUROPE] Iceland";
	...
	class CFP_MARKER_IRELAND : CFP_MARKER_BASE
	{
		name = "[EUROPE] Ireland";
	...
	class CFP_MARKER_LITHUANIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_LUXEMBOURG : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_MACEDONIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Macedonia";
	...
	class CFP_MARKER_MOLDOVA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Moldova";
	...
	class CFP_MARKER_NAGORNO_KARABAKH_REPUBLIC : CFP_MARKER_BASE
	{
		name = "[EUROPE] Nagorno-Karabakh Republic";
	...
	class CFP_MARKER_NETHERLANDS : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_REPUBLIC_ABKHAZIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of Abkhazia";
	...
	class CFP_MARKER_REPUBLIC_KOSOVO : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of Kosovo";
	...
	class CFP_MARKER_REPUBLIC_MALTA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of Malta";
	...
	class CFP_MARKER_REPUBLIC_SAN_MARINO : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of San Marino";
	...
	class CFP_MARKER_REPUBLIC_SERBIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of Serbia";
	...
	class CFP_MARKER_REPUBLIC_SOUTH_OSSETIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of South Ossetia";
	...
	class CFP_MARKER_REPUBLIC_TRANSNISTRIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Republic of Transnistria";
	...
	class CFP_MARKER_ROMANIA : CFP_MARKER_BASE
	{
		name = "[EUROPE] Romania";
	...
	class CFP_MARKER_SLOVAKIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_SLOVENIA : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_UKRAINE : CFP_MARKER_BASE
	{
		name = "[EUROPE] Ukraine";
	...
	class CFP_MARKER_UNITED_KINGDOM : CFP_MARKER_BASE
	{
	...
	class CFP_MARKER_VATICAN_CITY : CFP_MARKER_BASE
	{
		name = "[EUROPE] Vatican City State";
