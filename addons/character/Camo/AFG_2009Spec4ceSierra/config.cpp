...
class CfgVehicles
{
	...
	class AFG_2009Spec4ceSierra_BattleDressUniform: B_Soldier_base_F
	{
		...
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\BattleDressUniform.paa","\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\FieldUniform.paa"};   
        ...
        class AFG_2009Spec4ceSierra_PulloverUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\PulloverUniform.paa"};   
        ...
        class AFG_2009Spec4ceSierra_ReconUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\ReconUniform.paa","\x\cfp\addons\character\Uniforms\ReconUniform\0000_Standard\Tan2.paa"};   
		hiddenSelections[] = {"Camo1","Camo2","insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceSierra_FieldUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\FieldUniform.paa"};   
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceSierra_TacticalUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\TacticalUniform.paa"};   
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceSierra_TacticalUniform_TS: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\character\Camo\AFG_2009Spec4ceSierra\TacticalUniform.paa","\x\cfp\addons\character\Uniforms\Underwear\0000_Standard\Tan.paa"};   
