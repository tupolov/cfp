	...
	class CFP_BattleDressUniform_3ColorDesert: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_AfricanWoodland: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_ChocChip: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_m81: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_dpm: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_DPMWoodland: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_edrl: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_polygondesert: B_Soldier_base_F
	{
	...
	class CFP_BattleDressUniform_tigerstripe: B_Soldier_base_F
	{
