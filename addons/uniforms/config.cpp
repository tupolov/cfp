...
class CfgPatches
{
	class ADDON
	{
		units[] = {
			...
			"CFP_WorkUniform_DRK",
			"CFP_WorkUniform_DRK2",
			"CFP_WorkUniform_DRK2v2",
			"CFP_WorkUniform_DPM",
			"CFP_Crye_Black",
			"CFP_Crye_Black_SS",
			"CFP_Crye_M90",
			...
			"CFP_Crye_ATacsAU_SS",
			"CFP_Crye_Tropentarn",
			"CFP_Crye_Tropentarn_SS",
			"CFP_Crye_Flecktarn",
			"CFP_Crye_Flecktarn_SS",
		...
		weapons[] = {
			"CFP_75th_CRYE_Tee", 
			"CFP_75th_CRYE_Tee2", 
			"CFP_75th_CRYE_V1_Full", 
			"CFP_75th_CRYE_V1_Sleeved", 
			...
			"CFP_FieldUniform_iachocchip",
			"CFP_FieldUniform_iadcu",
			"CFP_FieldUniform_iadcu_SS",
			"cfp_fielduniform_iasblack_ss",
			"cfp_fielduniform_iasfblack",
			"CFP_FieldUniform_iasfblack",
			"CFP_FieldUniform_iasfblack_SS",
			"CFP_FieldUniform_ipdigital",
			"CFP_FieldUniform_ipdigital_SS",
			"CFP_FieldUniform_ipdpm",
			"CFP_FieldUniform_ipdpm_SS",
			"CFP_FieldUniform_marpatm81_SS",
			"CFP_FieldUniform_pesh_3cd",
			"CFP_FieldUniform_pesh_3cd_SS",
			"CFP_FieldUniform_pesh_edrl",
			"CFP_FieldUniform_pesh_edrl_SS",
			"CFP_FieldUniform_pesh_m81",
			"CFP_FieldUniform_pesh_m81_SS",
			"CFP_FieldUniform_police_sudan_SS",
			"CFP_FieldUniform_rogtan_SS",
			"CFP_FieldUniform_tanatacs_SS",
			...
			"CFP_U_Crye_Black_SS",
			"CFP_U_Crye_M90",
			"CFP_U_Crye_Flecktarn",
			"CFP_U_Crye_Flecktarn_SS",
			"CFP_U_Crye_IDF",
			"CFP_U_Crye_IDF_SS",
			"CFP_U_Crye_M81",
			"CFP_U_Crye_M81_SS",
			...
			"CFP_U_Crye_Tropentarn",
			"CFP_U_Crye_Tropentarn_SS",
			...
			"CFP_U_FieldUniform_iachocchip_SS",
			...
			"CFP_U_WorkUniform_ANP",
			"CFP_U_WorkUniform_BlackGrey",
			"CFP_U_WorkUniform_ChocChip",
			"CFP_U_WorkUniform_DDPM",
			"CFP_U_WorkUniform_DesTiger",
			"CFP_U_WorkUniform_DPM",
			"CFP_U_WorkUniform_DRK",
			"CFP_U_WorkUniform_DRK2",
			"CFP_U_WorkUniform_DRK2v2",
			"CFP_U_WorkUniform_Flecktarn",
			"CFP_U_WorkUniform_Green",
			"CFP_U_WorkUniform_M81",
			"CFP_U_WorkUniform_M81_Sudan",
			"CFP_U_WorkUniform_M81Des",
			"CFP_U_WorkUniform_SudanPolice",
			"CFP_U_WorkUniform_SudanPolice2",
			"CFP_U_WorkUniform_TanM81",
