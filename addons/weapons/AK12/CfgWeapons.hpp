	...
	class arifle_AK12_F;
	class CFP_AK12_Woodland: arifle_AK12_F
	{
		author = MODULE_AUTHOR;
		baseWeapon = "CFP_AK12_Woodland";
		displayName = "AK12 (Woodland)";
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\weapons\AK12\ak12atacs1.paa","\x\cfp\addons\weapons\AK12\ak12atacs2.paa"};
	};
	class arifle_AK12_GL_F;
	class CFP_AK12_GL_Woodland: arifle_AK12_GL_F
	{
		author = MODULE_AUTHOR;
