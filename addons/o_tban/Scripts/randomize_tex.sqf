...
if (isServer) then
{
	...
	if ((_class == "cfp_o_is_jeep_lmg") or
		(_class == "cfp_o_is_jeep_at")) then
	{
		...
		(_class == "CFP_O_TBAN_Hilux_UB_32_01")) then
	{
		...
		_this setObjectTextureGlobal [0, [
			"\x\cfp\addons\vehicles\Hilux\body_white_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_creme_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_tan_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_armygreen_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_red_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer1_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer2_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer3_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer4_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer5_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer6_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer7_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer8_co.paa",
			"\x\cfp\addons\vehicles\Hilux\body_guer9_co.paa"
		] select _randomSeed1];
	};
