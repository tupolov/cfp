class CfgPatches {
    class CFP_B_USMC_DES {
        units[] = {
            ...
            "CFP_B_USMC_Gunner_M2_High_DES_01",
            "CFP_B_USMC_Gunner_M2_Low_DES_01",
            "CFP_B_USMC_Asst_Gunner_M2_DES_01",
            "CFP_B_USMC_Asst_Gunner_M2Low_DES_01",
            "CFP_B_USMC_Gunner_TOW_DES_01",
            "CFP_B_USMC_Asst_Gunner_TOW_DES_01",
            "CFP_B_USMC_Gunner_Mortar_DES_01",
            "CFP_B_USMC_Asst_Gunner_Mortar_DES_01",
            "CFP_B_USMC_MARSOC_des",
            "CFP_B_USMC_MARSOC_TL_des",
            "CFP_B_USMC_MARSOC_TC_des",
            "CFP_B_USMC_MARSOC_OC_des",
            "CFP_B_USMC_MARSOC_CC_des",
            "CFP_B_USMC_MARSOC_EL_des",
            "CFP_B_USMC_MARSOC_AR_des",
            "CFP_B_USMC_MARSOC_Medic_des",
            "CFP_B_USMC_MARSOC_Marksman_des",
            "CFP_B_USMC_MARSOC_DA_des",
            "CFP_B_USMC_MARSOC_TL_DA_des",
            "CFP_B_USMC_MARSOC_TC_DA_des",
            "CFP_B_USMC_MARSOC_OC_DA_des",
            "CFP_B_USMC_MARSOC_CC_DA_des",
            "CFP_B_USMC_MARSOC_EL_DA_des",
            "CFP_B_USMC_MARSOC_AR_DA_des",
            "CFP_B_USMC_MARSOC_Medic_DA_des",
            "CFP_B_USMC_MARSOC_Marksman_DA_des"
        };
        weapons[] = {};
        requiredAddons[] = {
            "A3_Air_F_Beta",
