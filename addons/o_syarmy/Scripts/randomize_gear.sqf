...
if (isServer) then
{
	...
	if ((_class == "cfp_o_syarmy_grenadier") or
		(_class == "cfp_o_syarmy_rifleman") or
		(_class == "cfp_o_syarmy_rifleman_dshkm") or
		(_class == "cfp_o_syarmy_rifleman_kord") or
		(_class == "cfp_o_syarmy_rifleman_podnos") or
		(_class == "cfp_o_syarmy_rifleman_ags30") or
		(_class == "cfp_o_syarmy_rifleman_metis") or
		(_class == "cfp_o_syarmy_rifleman_spg9") or
		(_class == "cfp_o_syarmy_machinegunner") or
		(_class == "cfp_o_syarmy_sniper") or
		(_class == "cfp_o_syarmy_at") or
		(_class == "cfp_o_syarmy_medic") or
		(_class == "cfp_o_syarmy_sapper") or
		(_class == "cfp_o_syarmy_crewman")
		) then
	{
		...
		_this setObjectTextureGlobal [0, [
			"\x\cfp\addons\o_syarmy\data\saa_uniform_woodland.paa"
		] select _randomSeed1];
	...
	switch _class do
	{
		case "cfp_o_syarmy_officer":
		{
			...
			_this setObjectTextureGlobal [0, [
				"\x\cfp\addons\o_syarmy\data\saa_officer_woodland.paa"
			] select _randomSeed1];
