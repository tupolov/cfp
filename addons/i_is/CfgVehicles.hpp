...
class CfgVehicles
{
    ...
    class cfp_i_is_base: I_Soldier_A_F
    {
        ...
        class EventHandlers : EventHandlers
        {
            class ADDON
            {
                init = "(_this select 0) call CFP_main_fnc_randomizeUnit; (_this select 0) spawn CFP_i_is_fnc_randomizeUniform; [_this select 0, 'Male01_ackbar'] remoteExecCall ['setSpeaker', 0]; [_this select 0,'Male01_ackbar'] call cfp_main_fnc_setSpeakerRemote;";
            };
        };
