...
// Vehicles
	...
	class AFG_2009Spec4ceForest_BattleDressUniform: B_Soldier_base_F
	{
		...
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\BattleDressUniform.paa","\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\FieldUniform.paa"};
        ...
        class AFG_2009Spec4ceForest_PulloverUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\PulloverUniform.paa"};
        ...
        class AFG_2009Spec4ceForest_ReconUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\ReconUniform.paa","\x\cfp\addons\uniforms\ReconUniform\0000_Standard\Black2.paa"};
		hiddenSelections[] = {"Camo1","Camo2","insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceForest_FieldUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\FieldUniform.paa"};
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceForest_TacticalUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\TacticalUniform.paa"};
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2009Spec4ceForest_TacticalUniform_TS: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2009Spec4ceForest\TacticalUniform.paa","\x\cfp\addons\uniforms\Underwear\0000_Standard\Green.paa"};
