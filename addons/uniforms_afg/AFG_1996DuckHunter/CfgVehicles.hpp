...
// Vehicles
    ...
    class AFG_1996DuckHunter_BattleDressUniform: B_Soldier_base_F
    {
        ...
        hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_1996DuckHunter\BattleDressUniform.paa","\x\cfp\addons\uniforms_afg\AFG_1996DuckHunter\FieldUniform.paa"};
    ...
    class AFG_1996DuckHunter_FieldUniform: B_Soldier_base_F
    {
        ...
        linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
        respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
        hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_1996DuckHunter\FieldUniform.paa"};
        hiddenSelections[] = {"Camo", "insignia"};
        class Wounds
        {
            tex[] = {};
    ...
    class AFG_1996DuckHunter_TacticalUniform: B_Soldier_base_F
    {
        ...
        linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
        respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
        hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_1996DuckHunter\TacticalUniform.paa"};
        hiddenSelections[] = {"Camo", "insignia"};
        class Wounds
        {
            tex[] = {};
    ...
    class AFG_1996DuckHunter_TacticalUniform_TS: B_Soldier_base_F
    {
        ...
        linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
        respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
        hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_1996DuckHunter\TacticalUniform.paa","\x\cfp\addons\uniforms\Underwear\0000_Standard\Green.paa"};
