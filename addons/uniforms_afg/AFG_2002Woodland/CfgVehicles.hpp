...
// Vehicles
	...
	class AFG_2002Woodland_BattleDressUniform: B_Soldier_base_F
	{
		...
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\BattleDressUniform.paa","\x\cfp\addons\uniforms_afg\AFG_2002Woodland\FieldUniform.paa"};
        ...
        class AFG_2002Woodland_PulloverUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\PulloverUniform.paa"};
        ...
        class AFG_2002Woodland_ReconUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\ReconUniform.paa","\x\cfp\addons\uniforms\ReconUniform\0000_Standard\Black2.paa"};
		hiddenSelections[] = {"Camo1","Camo2","insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2002Woodland_FieldUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\FieldUniform.paa"};
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2002Woodland_TacticalUniform: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\TacticalUniform.paa"};
		hiddenSelections[] = {"Camo", "insignia"};
		class Wounds
		{
			tex[] = {};
	...
	class AFG_2002Woodland_TacticalUniform_TS: B_Soldier_base_F
	{
		...
		linkedItems[] = {"ItemWatch","ItemRadio","ItemGPS"};
		respawnLinkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
		hiddenSelectionsTextures[] = {"\x\cfp\addons\uniforms_afg\AFG_2002Woodland\TacticalUniform.paa","\x\cfp\addons\uniforms\Underwear\0000_Standard\Green.paa"};
