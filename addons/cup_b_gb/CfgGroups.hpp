    ...
    class WEST {
        ...
        class CUP_B_GB {
            ...
            class Infantry {
                ...
                class CUP_B_GB_infantry_M2_team_high {
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 1;
                        vehicle = "CUP_B_GB_Asst_Gunner_M2_DES_01";
                    };
                    class Unit1 {
                        position[] = {5,-5,0};
                        rank = "PRIVATE";
                        side = 1;
                        vehicle = "CUP_B_GB_Gunner_M2_High_DES_01";
                    };
                };

                class CUP_B_GB_infantry_M2_team_low {
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 1;
                        vehicle = "CUP_B_GB_Asst_Gunner_M2Low_DES_01";
                    };
                    class Unit1 {
                        position[] = {5,-5,0};
                        rank = "PRIVATE";
                        side = 1;
                        vehicle = "CUP_B_GB_Gunner_M2_Low_DES_01";
                    };
                };

                class CUP_B_GB_infantry_mortar_team {
                    name = "Mortar Team";
                    side = 1;
                    faction = "CUP_B_GB";
                    icon = "\A3\ui_f\data\map\markers\nato\b_inf.paa";
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 1;
                        vehicle = "CUP_B_GB_Asst_Gunner_Mortar_DES_01";
                    };
                    class Unit1 {
                        position[] = {5,-5,0};
                        rank = "PRIVATE";
                        side = 1;
                        vehicle = "CUP_B_GB_Gunner_Mortar_DES_01";
                    };
                };

                class CUP_B_GB_infantry_TOW_team {
                    name = "TOW Team";
                    side = 1;
                    faction = "CUP_B_GB";
                    icon = "\A3\ui_f\data\map\markers\nato\b_inf.paa";
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 1;
                        vehicle = "CUP_B_GB_Asst_Gunner_TOW_DES_01";
                    };
                    class Unit1 {
                        position[] = {5,-5,0};
                        rank = "PRIVATE";
                        side = 1;
                        vehicle = "CUP_B_GB_Gunner_TOW_DES_01";
                    };
                };
            };
