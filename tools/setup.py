...
def main():
    ...
    print("""
  ######################################
  # CFP Development Environment Setup #
  ######################################

  This script will create your CFP dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your CFP project folder:
    [Arma 3 installation directory]\\{} => CFP project folder
    P:\\{}                              => CFP project folder
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the CFP wiki to perform the setup manually.")
    else:
